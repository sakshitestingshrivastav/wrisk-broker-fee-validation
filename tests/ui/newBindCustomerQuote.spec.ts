...
test.describe.skip('New Bind Customer Quote Validation', () => {

    test.beforeEach(async ({ page }) => {

        const loginPage = new LoginPage(page);

        const username = process.env.NEWBIND_USERNAME;
        const password = process.env.NEWBIND_USER_PASSWORD;
    ...
    test('Verify new bind quote details are displayed', async ({ page }) => {
    ...
    test('Verify total includes broker fee for new bind customer', async ({ page }) => {
